...
import { addToWatchList, checkWatchlist } from "@/lib/appwrite";
        ...
        <View className="bg-black h-full">
          <ScrollView onScroll={handleScroll} scrollEventThrottle={16}>
            <View className="">
              ...
              <View className="flex-1 justify-end items-end px-4 pb-10">
                <Text className="text-white text-sm">{`<-- Swipe to View More`}</Text>
              </View>
